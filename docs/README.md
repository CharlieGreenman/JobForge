...
| [examples/README.md](../examples/README.md) | Fictional CV samples (per-role markdown), optional digest and sample report — starting point for new `cv.md` or contributor archetypes |
